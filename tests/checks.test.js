...
describe("mooc_node-mod6_quiz_bbdd", function () {
    ...
    it('', async function () { this.name = `1: Checking that the assignment directory exists...`;
        this.score = 0.5;
    ...
    it('', async function () { this.name = `3: Checking that the file quizzes.sqlite is read. Running 'list'...`;
        this.score = 1;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it('', async function () { this.name = `4: Checking that invalid input parameters are detected. Running 'test'...`;
        this.score = 1;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it('', async function () { this.name = `5: Checking that right answers are detected. Running 'test 1'...`;
        this.score = 1;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it('', async function () { this.name = `6: Checking that wrong answers are detected. Running 'test 1'...`;
        this.score = 1;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it('', async function () { this.name = `7: Checking that right answers are detected. Running 'play'...`;
        this.score = 1;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it('', async function () { this.name = `8: Checking that answers are correctly scored. Running 'play'...`;
        this.score = 1.5;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it('', async function () { this.name = `9: Checking that wrong answers are detected. Running 'play'...`;
        this.score = 1.5;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
    ...
    it('', async function () { this.name = `10: Checking that the wrong answer ends the game. Running 'play'...`;
        this.score = 1;
        if (error_critical) {
            this.msg_err = error_critical;
            should.not.exist(error_critical);
